...
public class DetinationEnchantment extends Enchantment implements PolymerObject {
    protected DetinationEnchantment(Rarity weight, EnchantmentTarget type, EquipmentSlot slotTypes) {
